...
import os
import our_code.rekognition_lambda as lam
from moto import mock_dynamodb2, mock_ssm, mock_rekognition
import boto3
import json


class TestrekognitionLambdaFunction(unittest.TestCase):
    def setUp(self):
        self.event ={'body':'{"base64img":"0000"}'}
    ...
    @mock_dynamodb2
    @mock_ssm
    @unittest.skip("not implemented in moto")
    ...
    def test_exception(self):
        ...
        res = lam.handler({}, {})
        self.assertDictEqual(res, self.response_exception)
